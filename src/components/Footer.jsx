  ...
  return (
    <Container>
      ...
      <Center>
        ...
        <List>
          <ListItem
          href="https://kimlong.netlify.app/"
          >Trang chủ mượn sách</ListItem>
          <ListItem
          href="https://quanlykimlong.netlify.app/"
          >Trang quản lý sách</ListItem>
          <ListItem
          href="https://kimlong.netlify.app/books/"
          >Danh sách đầu sách</ListItem>
          <ListItem
          href="https://kimlong.netlify.app/cart/"
      ...
      <Right>
        <Title>Liên hệ</Title>
        <ContactItem>
          <Room style={{marginRight:"10px"}}/> Thôn Hưng Long, xã Kim Long, huyện Châu Đức, BR-VT
        </ContactItem>
        <ContactItem>
          <Phone style={{marginRight:"10px"}}/> 02543 885 035
        </ContactItem>
        <ContactItem>
          <MailOutline style={{marginRight:"10px"}} /> chauduc_tieuhoc_kimlong@barivungtau.edu.vn
        </ContactItem>
